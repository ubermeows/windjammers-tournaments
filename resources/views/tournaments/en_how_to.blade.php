...
<div class="px-4 pt-16 pb-10 mx-auto max-w-7xl sm:px-6 lg:px-8">
    <div class="max-w-3xl mx-auto prose">
        ...
        <h2>5. Add the tournament lobby</h2>
        ...
        <h2>6. Set your account for ranked games</h2>
